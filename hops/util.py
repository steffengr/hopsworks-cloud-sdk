...
def get_requests_verify(hostname, port, hostname_verification=True, trust_store_path=None):
    """
...
def prepare_requests(hostname_verification=True, trust_store_path=None):
    ...
    verify = get_requests_verify(host, port, hostname_verification=hostname_verification,
